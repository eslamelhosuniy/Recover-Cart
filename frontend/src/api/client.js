...
export const emailMarketingApi = {
  ...
  syncProviderData: (storeId) => apiClient.post(`/email-marketing/sync-provider/${storeId}`),
  getMailgunDomainStatus: (storeId) => apiClient.get(`/email-marketing/mailgun/${storeId}/domain-status`),
  getMailgunIpWarmup: (storeId) => apiClient.get(`/email-marketing/mailgun/${storeId}/ip-warmup`),
  toggleMailgunIpWarmup: (storeId, data) => apiClient.post(`/email-marketing/mailgun/${storeId}/ip-warmup/toggle`, data),
